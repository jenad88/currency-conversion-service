package com.johnenad.microservices.currencyconversionservice.resource;

import java.math.BigDecimal;
import java.util.HashMap;
import java.util.Map;

import com.johnenad.microservices.currencyconversionservice.util.containerservice.ContainerMetaDataService;
...
public class CurrencyConversionController {
    ...
    @Value("${CURRENCY_EXCHANGE_URI:http://localhost:8080}")
